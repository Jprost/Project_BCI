function [ERD_ERS_mat, t, f] = spectrogram_from_many_epochs(trials, fs, window_time, non_overlap_time)
    ...
    for ep=1:1:size(trials, 1)
        ...
        [ERD_ERS_ep, t, f] = spectrogram_from_epoch(squeeze(trials(ep,:)), fs, window_time, non_overlap_time);
        ERD_ERS_mat = cat(3, ERD_ERS_mat, ERD_ERS_ep);
    end
end
