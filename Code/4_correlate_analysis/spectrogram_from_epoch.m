function [ERD_ERS, t, f] = spectrogram_from_epoch(epoch, baseline, fs, window_time, non_overlap_time)
    ...
    % get mean base line in -2 to -0 seconds
    B = repmat(baseline, 1, size(power,2));
