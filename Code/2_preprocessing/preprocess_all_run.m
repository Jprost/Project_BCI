function preprocess_runs = preprocess_all_run(runs_data, Laplacian, CAR, filtering)
    ...
    for i=1:1:size(runs_data,2)
        struct_tmp = struct('signal', preprocess_one_run(runs_data(i).signal, Laplacian, CAR, filtering), ... 
