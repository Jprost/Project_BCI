% Global Script for PERFECT data
...
% data localisation
datafolder_path = './../data/test_data/20191902/train/';
channel_loc_path = './../data/channel_location_16_10-20_mi.mat';

% load the data
RunsData = load_data_from_runs(datafolder_path, channel_loc_path);
save('../outputs/output_perfect_online/runsData.mat','RunsData')

% online data 
RunsDataOnline = load_data_from_runs('./../data/test_data/20191902/test/', channel_loc_path);
...
save('../outputs/output_perfect_online/FilteredRunsData.mat','FilteredData')
save('../outputs/output_perfect_online/FilteredRunsDataOnline.mat','FilteredDataOnline')
...
save('../outputs/output_perfect_online/epoch_baseline.mat','epoch_baseline')

% epochs centered on MI-start
epoch_MI_Start = epoching_from_event(FilteredData, 300, 3, 3);
save('../outputs/output_perfect_online/epoch_MI_Start.mat','epoch_MI_Start')

% epochs centered on MI stop
epoch_MI_Stop = epoching_from_event(FilteredData, 555, 3, 3);
save('../outputs/output_perfect_online/epoch_MI_Stop.mat','epoch_MI_Stop')


%% Feature Extraction

%Load Epochs
load('./../outputs/output_perfect_online/epoch_MI_Stop.mat')
