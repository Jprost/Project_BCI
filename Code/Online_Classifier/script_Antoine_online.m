...
% data localisation
datafolder_path = './../data_online/data_Antoine/data_train/';
...
save('../outputs/output_antoine_online/FilteredRunsData.mat','FilteredData')
save('../outputs/output_antoine_online/FilteredRunsDataOnline.mat','FilteredDataOnline')
...
save('../outputs/output_antoine_online/epoch_baseline.mat','epoch_baseline')

% epochs centered on MI-start
epoch_MI_Start = epoching_from_event(FilteredData, 300, 3, 3);
save('../outputs/output_antoine_online/epoch_MI_Start.mat','epoch_MI_Start')

% epochs centered on MI stop
epoch_MI_Stop = epoching_from_event(FilteredData, 555, 3, 3);
save('../outputs/output_antoine_online/epoch_MI_Stop.mat','epoch_MI_Stop')


%% Feature Extraction

%Load Epochs
load('./../outputs/output_antoine_online/epoch_MI_Stop.mat')
